# Prosta klasa przechowująca wszystkie konsole z pdf i umozliwiajaca zbieranie punktow
# a potem okreslenie konsoli, ktora zdobyla ich najwiecej.
class ConsoleContainer:

    def __init__(self):
        self.consoles = [
            'Atari_7800', 'NES', 'Master_System', 'Neo_Geo', 'TurboGrafx_16', 'SNES',
            'Mega_Drive', 'Game_Boy', 'Sega_Game_Gear', 'Atari_Lynx', 'Nintendo_64',
            'Atari_Jaguar', 'Sega_Saturn', '3DO', 'Playstation', 'Neo-Geo_Pocket',
            'WonderSwan', 'Virtual_Boy', 'Game_Boy_Color', 'Dreamcast', 'GameCube',
            'Playstation_2', 'Xbox', 'Game_Boy_Advance', 'N-Gage', 'Neo-Geo_Pocket_Color']
    ...
    # adds given amount of points to specified console. Throws exceptions if arguments are invalid.
